...
2. Manipulation is slow using ArrayList bcz lots of shifting
3. Better for storing and accessing data
LinkedList:
1. LinkedList uses doubly linked list to store the elements.
2. Manipulation is faster than ArrayList bcz it uses doubly linked list
3. Better for manipulating the data
		 */
